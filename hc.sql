...
/*!40101 SET @OLD_CHARACTER_SET_RESULTS=@@CHARACTER_SET_CLIENT */;
...
CREATE DATABASE hc CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE hc;
...
INSERT INTO `usuario`
(`id_usuario`, `password_hash`, `rol`, `nombres`, `apellido_paterno`, `apellido_materno`, `email`, `estado`, `fecha_creacion`)
VALUES
(1001,'$2a$10$IbcqC2pPvWMNVN/P/Cv.VuMAECRD7gYRch4OZoQ9u1dlEuR3GZyui','ADMIN','Atenas','Bonifaz','Obando','atenas@gmail.com','ACTIVO','2026-02-08 05:03:38'),
(1002,'$2a$10$4d5edMEGLPWRSBgkXgddK.vjecSLTffk2j3Di83pW3Ev5DTxCApUW','MEDICO','Andrea','Torres','Cerdan','Andrea@gmail.com','ACTIVO','2026-02-08 05:03:38');

INSERT INTO usuario (password_hash, rol, nombres, apellido_paterno, apellido_materno, email, estado)
VALUES ('$2a$10$IvOlz2Gfa3Q8hqmpDqAMpe407PdQ58SMIFaqEiDvz8vohuAhXyzFS',
        'ADMISION', 'Farid', 'Urquiza', 'Saavedra', 'farid@gmail.com', 'ACTIVO');
...
(1001,'Andrea','Torres','Traumatología',NULL,NULL,'ACTIVO','2026-02-08 05:03:38',NULL,NULL,1001),
...
/* Corrijo Pérez,Gómez => Pérez / Gómez
   + agrego 3 pacientes extra con APELLIDOS DIFERENTES */
INSERT INTO `paciente`
(`id_paciente`,`tipo_documento`,`nro_documento`,`nombres`,`sexo`,`fecha_nacimiento`,`telefono`,`direccion`,`estado`,`fecha_registro`,`apellido_paterno`,`apellido_materno`)
VALUES
(1001,'DNI','74581236','Carlos','M','1998-06-15','987654321','Av. Siempre Viva 742','ACTIVO','2026-01-30 06:43:04','Pérez','Gómez'),
(1003,'DNI','73118847','FARID ISRAEL','M','2005-03-27','922941107','av.hola','ACTIVO','2026-02-05 11:57:43','Urquiza','Saavedra'),
(1004,'DNI','74074569','GONZALO RAMON','M','2026-02-05','77777','rr','ACTIVO','2026-02-05 12:00:26','Sarmient','Olivo');
...
(`id_historia`,`nro_historia_clinica`,`fecha_apertura`,`estado`,`id_paciente`)
VALUES
(5001,'HC-1003','2026-02-08 05:03:38','ACTIVO',1003);
...
(`id_admision`,`fecha_admision`,`id_historia`,`id_medico`,`id_usuario`,`area`,`id_paciente`)
VALUES
(9001,'2026-02-08 05:03:59',5001,1001,1001,'Traumatología',1003);
...
INSERT INTO `pago` (`id_pago`, `id_admision`, `monto`, `metodo_pago`, `fecha_pago`, `estado`)
VALUES
(1, 9001, 50.00, 'EFECTIVO', '2026-02-08 05:06:10', 'PENDIENTE'),
(2, 9001, 30.00, 'TARJETA',   '2026-02-08 05:10:45', 'ANULADO');
...
CREATE TABLE `detalle_historia_clinica` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_detalle_paciente` (`id_paciente`),
  KEY `fk_detalle_medico` (`id_medico`),
  CONSTRAINT `fk_detalle_paciente` FOREIGN KEY (`id_paciente`) REFERENCES `paciente` (`id_paciente`),
